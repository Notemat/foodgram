...
class TestSubscriptions:
    ...
    def test_01_not_subscribe_himself(self, first_user_id):
    ...
    def test_02_unauthorized_user_cant_subscribe(self, client, second_user_id):
        """
    ...
    def test_03_subscribe_twice(self, create_subscription, second_user_id):
        """
    ...
    def test_04_get_subscriptions(self, create_subscription):
        """Проверяем доступность списка подписок."""
        response = self.authenticated_client.get(self.SUBSCRIPTION_URL)
        assert response.status_code == 200
        assert "results" in response.data

    def test_05_unauthorized_user_cant_get_subscriptions(self, client):
        """
    ...
    def test_06_delete_subscribe(self, create_subscription, second_user_id):
    ...
    def test_07_delete_not_subscriber(self, second_user_id):
        """
    ...
    def test_08_unauthorized_user_cant_delete(self, client, second_user_id):
        """
        Проверяем, что неавторизованный пользователь
